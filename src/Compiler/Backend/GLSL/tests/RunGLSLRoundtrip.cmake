...
if(DEFINED GLSLANG_TARGET_ENV AND NOT GLSLANG_TARGET_ENV STREQUAL "")
    set(GLSLANG_TARGET_ARGS --target-env "${GLSLANG_TARGET_ENV}")
endif()
...
execute_process(
    COMMAND "${GLSLANG}" -V ${GLSLANG_TARGET_ARGS} "${XSC_OUTPUT}" -o "${XSC_OUTPUT}.spv"
